...
export const ShiftTimingCreationPagesStyle={
    ...
    gridContinerStyle:{display:"flex",justifyContent:"center",alignContent:"center"},
    gridItemStyle:{display:"flex",justifyContent:"center",alignContent:"center"},
    textFieldStyle:{width:490},
    shiftStartAndEndBoxStyle:{width:500},
    TextFieldOfShiftStartAndEndBoxStyle:{display:'flex',width:240},
    FormControlOfShiftStartAndEndBoxStyle:{width: 240,marginLeft:"10px" },
    thirdBoxStyle:{ marginTop:"15px"}
    }
