import { Autocomplete, Box, Button, Container, FormControl, Grid, InputLabel, MenuItem, Paper, Select, TextField, Typography } from '@mui/material'
...
const history=useNavigate()
  ...
  return hasAuthority(REPORTING_MANAGER_CREATE_SKILL_REPORT_PAGE_TITLE)? (
    ...
    <Box style={EmployeeSkillReportStyle.secondBox}>
        
                <Typography style={EmployeeSkillReportStyle.TypographyStyle} >MAKE A SKILL REPORT</Typography>

                <Grid style={{justifyContent:"center"}}>
                <Button variant='outlined' style={EmployeeSkillReportStyle.backButtonStyle} 
            ...
            <GlobalButton.GlobalDivider></GlobalButton.GlobalDivider>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <Box style={EmployeeSkillReportStyle.thirdBoxStyle}>
